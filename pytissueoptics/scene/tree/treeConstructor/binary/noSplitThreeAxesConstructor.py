...
from pytissueoptics.scene.tree.treeConstructor.binary.noSplitOneAxisTreeConstructor import NoSplitOneAxisTreeConstructor


class NoSplitThreeAxisTreeConstructor(NoSplitOneAxisTreeConstructor):
