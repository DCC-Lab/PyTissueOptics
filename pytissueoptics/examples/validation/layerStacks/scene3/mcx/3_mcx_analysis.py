...
layer1 = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 0, 1)])
layer2 = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 1, 1)])
layer3 = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 2, 2)])
