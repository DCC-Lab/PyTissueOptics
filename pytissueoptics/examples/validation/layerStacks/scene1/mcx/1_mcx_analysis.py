...
layer1Energy = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 0, 10)])
layer2 = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 10, 10)])
layer3 = np.sum([data[x, y, z] for x, y, z in find_voxel_indices_in_layer(100, 1, 20, 20)])
a = np.asarray(data).shape
print("\n========================================")
print(f"Layer 1 Absorbed Energy: {layer1Energy}")
print(f"Layer 2 Absorbed Energy: {layer2}")
print(f"Layer 3 Absorbed Energy: {layer3}")
print("========================================")
print(f"Total Absorbed Energy: {layer1Energy + layer2 + layer3}", "total energy in the domain: ", np.sum(data))
print("========================================")
