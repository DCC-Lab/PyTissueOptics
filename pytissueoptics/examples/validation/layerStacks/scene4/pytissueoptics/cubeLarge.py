...
def exampleCode():
    ...
    for ua in np.linspace(0.001, 0.05, 50):
        tissue = ScatteringScene([Cuboid(200,b=200, c=6, material=ScatteringMaterial(mu_a=ua, mu_s=1, g=0.01, n=1), label="cube")])
        logger = EnergyLogger(tissue, defaultBinSize=0.5)
        source = PencilPointSource(position=Vector(0, 0, -499.99), direction=Vector(0, 0, 1), N=N, displaySize=1)
